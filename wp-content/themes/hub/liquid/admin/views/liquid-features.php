<div class="lqd-dsd-box lqd-dsd-activation-tut-box">
	...
	<h4><?php esc_html_e( 'How can I activate my Theme', 'hub' ); ?></h4>
	<p><?php esc_html_e( 'Here is a video tutorial to assist you:', 'hub' ); ?></p>

	<div class="lqd-dsd-vid">
		<button class="lqd-dsd-vid-trigger" data-lqd-dsd-lightbox="#lqd-dsd-activation-tut-vid">
			<img src="<?php echo get_template_directory_uri() . '/liquid/assets/img/dashboard/theme-activation.jpg' ?>" alt="<?php esc_attr_e( 'Theme activation', 'hub' ); ?>">
		</button>
	</div>
