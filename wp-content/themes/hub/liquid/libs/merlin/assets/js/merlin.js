...
var Merlin = (function($){
    ...
    function window_loaded(){
        ...
        function el_button(){
			...
			$( "#default_plugins_elementor, #default_plugins_hub-booking" ).attr( 'disabled', false );
			$( "#default_plugins_elementor, #default_plugins_hub-booking" ).parent().css( "display", "list-item" );
        }
        ...
        function vc_button(){
			...
			$( "#default_plugins_elementor, #default_plugins_hub-booking" ).prop( 'checked', false );
			$( "#default_plugins_elementor, #default_plugins_hub-booking" ).attr( 'disabled', true );
			$( "#default_plugins_elementor, #default_plugins_hub-booking" ).parent().css( "display", "none" );
        }
